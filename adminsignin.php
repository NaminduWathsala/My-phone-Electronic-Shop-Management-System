...
<head>
    <title>MYphone | Admin | Sign In</title>
    <meta charset="utf-8">
...
<body style="background-color: #DFFF00;background-image: linear-gradient(60deg,#AF7AC5 0%,#1ABC9C 70%);">
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center title1">Hi, Welcome To MYphone Admins</p>
                    </div>
                </div>
            </div>
