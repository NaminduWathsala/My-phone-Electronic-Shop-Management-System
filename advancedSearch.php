...
<head>
    ...
    <title>MYphone | Advanced Search</title>
...
<body onload="advancedSearch(0);" class="bg-info">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 border border-primary border-start-0 border-end-0 border-top-0" style="background-color: #e9f5fb;">
                ...
                <div class="row">
                    <div class="offset-0 offset-lg-4 col-12 col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <lable class="text-black fw-bold fs-2 mt-4">Advanced Search</lable>
                            </div>
            ...
            <div class="offset-0 offset-lg-2 col-12 col-lg-8 mt-3 mb-3 rounded" style="background-color: #e9f5fb;">
                <div class="row">
            ...
            <div class="offset-o offset-lg-2 col-12 col-lg-8 mt-3 mb-3 rounded" style="background-color: #e9f5fb;">
                <div class="row">
            ...
            <div class="offset-0 offset-lg-2 col-12 col-lg-8 mb-3 rounded" id="filter" style="background-color: #e9f5fb;">
                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="row g-1">
                                                            <div class="col-12 col-lg-6 d-grid">
                                                                <a class="btn btn-success fs" onclick="sendid(<?php echo $productImage['id'] ?>);">Update</a>
                                                            </div>
                                                            <div class="col-12 col-lg-6 d-grid">
                                                                <a class="btn btn-danger fs" onclick="deleteModel(<?php echo $productImage['id'] ?>);">Delete</a>
                                                            </div>
                                                        </div>
