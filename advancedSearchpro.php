...
<div class="row">
    <div class="offset-0 offset-lg-1 col-12 col-lg-10 text-center">
        <div class="row ">
            ...
            $productst = Database::search("SELECT * FROM model_has_brand WHERE model_has_brand.brand_id='" . $b . "' AND model_has_brand.model_id='" . $m . "';");

            $productst = Database::search($quvry);
            $nProduct = $productst->num_rows;
            $userProduct = $productst->fetch_assoc();
